    ...
    resource: {
      ...
      tags: [
        ...
        },
        {
          ...
          once_per_event: true,
          vtp_html: '\u003Cscript type="text/gtmscript"\u003Etd.setSignedMode();td.set("$global","td_global_id","td_global_id");td.set("x_saomovie_of_accesslog");td.trackPageview("x_saomovie_of_accesslog");\u003C/script\u003E',
          vtp_supportDocumentWrite: false,
          vtp_enableIframeMode: false,
          vtp_enableEditJsMacroBehavior: false,
          tag_id: 7,
      ...
      predicates: [
        ...
        { function: "_sw", arg0: ["macro", 2], arg1: "https://sao-p.net/" },
      ],
      rules: [
        [
          ["if", 0],
...
*/
 ...
 jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    ...
    ic = function (a, b, c) {
      if (ra(a)) {
        ...
        switch (a[0]) {
          ...
          case "escape":
            d = ic(a[1], b, c);
            if (ec && ra(a[1]) && "macro" === a[1][0] && ec.Di(a)) return ec.Ui(d);
            d = String(d);
            for (var t = 2; t < a.length; t++) zb[a[t]] && (d = zb[a[t]](d));
            return d;
          case "tag":
            var u = a[1];
            if (!ac[u]) throw Error("Unable to resolve tag reference " + u + ".");
  ...
  Dd.xd = "7b0";
  Dd.aa = "dataLayer";
  Dd.gh = "ChAI8Nq5lgYQ6vqp9bzDqPA7EiQAH9ctxdshVev6ulcDki/6klKjAukQnd4mCLXyffH/NsSB7UUaAnxY";
  var Fd = { __cl: !0, __ecl: !0, __ehl: !0, __evl: !0, __fal: !0, __fil: !0, __fsl: !0, __hl: !0, __jel: !0, __lcl: !0, __sdl: !0, __tl: !0, __ytl: !0 },
  ...
  var ne = /:[0-9]+$/,
    ...
    re = function (a, b, c, d, e) {
      ...
      if ("protocol" === b || "port" === b) a.protocol = pe(a.protocol) || pe(F.location.protocol);
      "port" === b
        ? (a.port = String(Number(a.hostname ? a.port : F.location.port) || ("http" === a.protocol ? 80 : "https" === a.protocol ? 443 : "")))
        : "host" === b && (a.hostname = (a.hostname || F.location.hostname).replace(ne, "").toLowerCase());
      return qe(a, b, c, d, e);
    },
  ...
  function ef() {
    ...
    a.ics || (a.ics = { entries: {}, set: ff, update: gf, addListener: hf, notifyListeners: jf, active: !1, usedDefault: !1, usedUpdate: !1, accessedDefault: !1, accessedAny: !1, wasSetLate: !1 });
    return a.ics;
  }
      ...
      if ("" === d || p === e || (p === d ? n !== e : !p && !n)) {
        ...
        q &&
          F.setTimeout(function () {
            k[a] === r && r.quiet && ((r.quiet = !1), kf(a), jf(), Sc("TAGGING", 2));
          }, f);
      }
    }
  }
  ...
  var yf = [T.g.H, T.g.M],
    zf = function (a) {
      ...
      var c = a[T.g.nf];
      c && Q(41);
      for (var d = ra(b) ? b : [b], e = { Tb: 0 }; e.Tb < d.length; e = { Tb: e.Tb }, ++e.Tb)
        wa(
          a,
          (function (f) {
            return function (g, k) {
  ...
  function Of(a, b, c) {
    for (var d = [], e = Nf(a, void 0, void 0, c), f = 0; f < e.length; f++) {
      ...
      if (!b || -1 !== b.indexOf(k)) {
        var l = g.shift();
        l && ((l = l.split("-")), d.push({ id: g.join("."), Ed: 1 * l[0] || 1, Fc: 1 * l[1] || 1 }));
      }
    }
    return d;
  }
  ...
  var gg = { I: "GTM-NJ3J9R3", Wb: "" },
    hg = { Hg: "GTM-NJ3J9R3", Ig: "GTM-NJ3J9R3" },
    ig = function () {
      var a = [gg.I];
      hg.Hg && (a = hg.Hg.split("|"));
      return a;
  ...
  var pg = { "": "n", UA: "u", AW: "a", DC: "d", G: "e", GF: "f", HA: "h", GTM: ng, OPT: "o" },
    Bg = function (a) {
      var b = gg.I.split("-"),
        c = b[0].toUpperCase(),
        d = pg[c] || "i",
  ...
  Kg.prototype.addEventListener = function (a) {
    ...
    var f = function (g, k) {
      clearTimeout(e);
      g
        ? ((c = g), (c.internalErrorState = Jg(c)), (c.internalBlockOnErrors = b.D), (k && 0 === c.internalErrorState) || ((c.tcString = "tcunavailable"), k || (c.internalErrorState = 3)))
  ...
  var Ng = function (a, b, c) {
      ...
      else l = 1 === k ? (a.purpose && a.vendor ? Mg(a.purpose.legitimateInterests, b) && Mg(a.vendor.legitimateInterests, void 0 === d ? "755" : d) : !0) : !0;
      return l;
    },
    Mg = function (a, b) {
      return !(!a || !a[b]);
              ...
              for (g in Rg)
                if (Rg.hasOwnProperty(g))
                  if ("1" === g) {
                    ...
                    !1 === p.gdprApplies
                      ? (n = !0)
                      : (void 0 === p.internalErrorState && (p.internalErrorState = Jg(p)),
                    ...
                    f["1"] = n ? (!1 === k.gdprApplies || "tcunavailable" === k.tcString || (void 0 === k.gdprApplies && !l) || "string" !== typeof k.tcString || !k.tcString.length ? !0 : Ng(k, "1", 0)) : !1;
  ...
  function Xg(a) {
    ...
    Bf(c, { eventId: 0 }, { gdprApplies: a ? a.gdprApplies : void 0, tcString: $g() });
  }
  var $g = function () {
      var a = Ug();
  ...
  function hh(a, b, c) {
    ...
    if (!d) return !1;
    var e = d.split(".");
    5 === e.length ? ((eh[a] = e.slice(0, 2).join(".")), (fh[a] = { id: e.slice(2, 4).join("."), Cg: Number(e[4]) || 0 })) : 3 === e.length ? (fh[a] = { id: e.slice(0, 2).join("."), Cg: Number(e[2]) || 0 }) : (eh[a] = d);
    return !0;
  }
  function gh(a) {
    return (a || "_gcl") + "_au";
  ...
  function Bh(a, b) {
    ...
    ph = d;
    for (var l = 4294967295, n = 0; n < c.length; n++) l = (l >>> 8) ^ ph[(l ^ c.charCodeAt(n)) & 255];
    ...
    Zh = function (a) {
      ...
      for (var d = {}, e = 0; e < c.length; d = { Pc: d.Pc }, e++) {
        ...
        if (null != f) {
          ...
          p ? ((p.timestamp = Math.max(p.timestamp, l)), (p.labels = bi(p.labels, n || []))) : b.push({ version: k, Ca: d.Pc, timestamp: l, labels: n });
        }
      }
      b.sort(function (q, r) {
  ...
  function gi(a, b, c, d, e) {
    ...
    if ((void 0 == Rh.enable_gbraid_cookie_write ? 0 : Rh.enable_gbraid_cookie_write) && !l && a.gb) {
      var q = a.gb[0],
        r = ii("gb", g),
        t = !1;
      if (!b) for (var u = Zh(r), v = 0; v < u.length; v++) u[v].Ca === q && u[v].labels && 0 < u[v].labels.length && (t = !0);
      t || f("gb", p(q));
    }
  }
  var ki = function (a, b) {
    ...
    ji = function (a) {
      return 0 !== li(a.split(".")).length ? 1e3 * (Number(a.split(".")[1]) || 0) : 0;
    };
  function ai(a) {
    var b = li(a.split("."));
    return 0 === b.length ? null : { version: b[0], Ca: b[2], timestamp: 1e3 * (Number(b[1]) || 0), labels: b.slice(3) };
  }
  function li(a) {
  ...
  var mi = function (a, b, c, d, e) {
    ...
    ni = function (a, b) {
      if (Kf(F)) {
        for (var c = di(b.prefix), d = {}, e = 0; e < a.length; e++) Wh[a[e]] && (d[a[e]] = Wh[a[e]]);
        Yh(function () {
          wa(d, function (f, g) {
  ...
  function qi(a, b) {
    var c = di(b),
      d = ii(a, c);
    if (!d) return 0;
    for (var e = Zh(d), f = 0, g = 0; g < e.length; g++) f = Math.max(f, e[g].timestamp);
    return f;
  }
  function ri(a) {
    var b = 0,
    ...
    zi = function (a) {
      if (m(a)) {
        ...
        if (!(0 > b)) {
          ...
          if (xi.test(c)) {
            for (var d = a.substring(b + 1).split("/"), e = 0; e < d.length; e++) if (!d[e] || (yi.test(d[e]) && ("AW" !== c || 1 !== e))) return;
  ...
  var Fi = function (a, b, c) {
      ...
      var d = Ei();
      F[a.functionName] = d;
      if (a.Bd) for (var e = 0; e < a.Bd.length; e++) F[a.Bd[e]] = F[a.Bd[e]] || Ei();
    ...
    Gi = { functionName: "_googWcmImpl", Ld: "_googWcmAk", hf: "www.gstatic.com/wcm/loader.js" },
    Hi = { functionName: "_gaPhoneImpl", Ld: "ga_wpid", hf: "www.gstatic.com/gaphone/loader.js" },
    Ii = { bh: "", Vh: "5" },
    Ji = { functionName: "_googCallTrackingImpl", Bd: [Hi.functionName, Gi.functionName], hf: "www.gstatic.com/call-tracking/call-tracking_" + (Ii.bh || Ii.Vh) + ".js" },
    Ki = {},
    Li = function (a, b, c, d) {
      Q(22);
      if (c) {
    ...
    Mi = function (a, b, c, d) {
      ...
      if (b && c) {
        ...
        for (var e = { countryNameCode: c, destinationNumber: b, retrievalTime: Da() }, f = 0; f < a.length; f++) {
          var g = a[f];
          Ki[g.id] || (g && "AW" === g.prefix && !e.adData && 2 <= g.K.length ? ((e.adData = { ak: g.K[0], cl: g.K[1] }), (Ki[g.id] = !0)) : g && "UA" === g.prefix && !e.gaData && ((e.gaData = { gaWpid: g.containerId }), (Ki[g.id] = !0)));
        }
            ...
            if (l) {
              ...
              for (var y = 0; y < n.length; y++)
                if (y < v)
                  ...
                  else if ("AW" === a.prefix && a.K[1]) Ni() ? Mi([a], n[y], t || "US", { Oa: u, options: r }) : Li(a.K[0], a.K[1], n[y], { Oa: u, options: r });
                  else if ("UA" === a.prefix)
  ...
  function qj(a, b) {
    ...
    jb(a, void 0, { allow: "join-ad-interest-group" }, { taggingId: b, loadTime: B() }, c);
  }
  var rj = function () {
    if (pa(F.__uspapi)) {
      var a = "";
  ...
  var bk = function (a) {
    ...
    ok = function (a) {
      ...
      if (void 0 !== Zj && (!tk[Zj] || uk || vk || bk(a)))
        if (void 0 === dk[Zj] && (wk[Zj] || xk.Ei() || 0 >= yk--)) Q(1), (wk[Zj] = !0);
        else {
          void 0 === dk[Zj] && xk.bj();
          var b = nk(!0, a);
          a ? rb(b) : kb(b);
  ...
  var Pk = Mk,
    Jk = "https://www.googletagmanager.com/a?id=" + gg.I + "&cv=6",
    Qk = { label: gg.I + " Container", children: [{ label: "Initialization", children: [] }] },
    Fk = Hk(),
    tk = {},
    uk = "",
    vk = "",
  ...
  var ul = function (a, b) {
    return { entityType: 1, indexInOriginContainer: a, nameInOriginContainer: b, originContainerId: gg.I };
  };
  var wl = function (a, b) {
      this.h = !1;
      this.D = [];
  ...
  function Tl(a, b, c, d) {
    ...
    if (g && g.length) {
      var k = g[0];
      f = Tl(k.index, { onSuccess: f, onFailure: 1 === k.ug ? b.terminate : f, terminate: b.terminate }, c, d);
    }
    return f;
  }
  function Ul(a, b, c, d) {
      ...
      if (a[d]) {
        ...
        try {
          ...
          if (g) {
            ...
            var q = cc[p];
            l.call(k, { Sg: n, Kg: q ? q.priorityOverride || 0 : 0, execute: g });
          } else wm(d, b), f();
        } catch (t) {
          f();
        }
  ...
  function Em(a) {
    for (var b = [], c = 0; c < a.length; c++) a[c] && (Fd[String(ac[c][yb.qb])] && (b[c] = !0), void 0 !== ac[c][yb.Uh] && (b[c] = !0));
    return b;
  }
  function Fm(a, b) {
    if (!b) return b;
    for (var c = 0; c < a.length; c++) if (a[c] && ac[c] && !Hd[String(ac[c][yb.qb])]) return !0;
    return !1;
  }
  var Hm = function (a, b) {
      this.eventId = a;
            ...
            if (c.isGtmEvent || eo(b, n.createOnlyFields)) {
              ...
              d &&
                ...
                l(function () {
                  ...
                  !t ||
                    (t.get("clientId") == p && q) ||
                    (c.isGtmEvent ? ((n.fieldsToSet["&gcu"] = "1"), (n.fieldsToSet["&gcut"] = Ad[f])) : ((n.fieldsToSend["&gcu"] = "1"), (n.fieldsToSend["&gcut"] = Ad[f])),
                    t.set(n.fieldsToSet),
    ...
    po = function (a, b, c) {
      ...
      if (pa(k)) {
        ...
        var p = function (K) {
          ...
          q = function (K) {
            ...
            if (N) {
              ...
              var R = N.action;
              if (S || "impressions" === R) if ((O("ec:addImpression", N.Bg), !S)) return;
          ...
          r = function (K) {
            if (K) {
              var O = {};
              if (wb(K)) for (var S in ko) ko.hasOwnProperty(S) && lo(ko[S], S, K[S], O);
              go(O, x);
              p("require", "linkid", O);
            }
          },
          t = function () {
            if (fg()) {
              ...
              K && (p("require", K, { dataLayer: Dd.aa }), p("require", "render"));
            }
          },
          u = co(n, b, c),
          v = function (K, O, S) {
        ...
        if (b === T.g.Yb)
          ...
          b === T.g.Ea
            ? (t(), Oi(f, c), c.getWithConfig(T.g.cb) && (pi(["aw", "dc"]), Ll(n + ".")), 0 != u.sendPageView && p("send", "pageview", u.fieldsToSend), fo(f, n, c))
            : b === T.g.La
            ? $n(n, c)
            : "screen_view" === b
      ...
      function c(f) {
        ...
        function k() {
          if (f.category) l.category = f.category;
            ...
            for (var p = "", q = 0; q < ro.length; q++) void 0 !== f[ro[q]] && (p && (p += "/"), (p += f[ro[q]]));
            p && (l.category = p);
          }
        }
        var l = M(f),
  ...
  var oo,
    ...
    zo = {},
    Yn = Object.freeze(
      ((zo.campaign = { content: "campaignContent", id: "campaignId", medium: "campaignMedium", name: "campaignName", source: "campaignSource", term: "campaignKeyword" }),
      (zo.app_id = 1),
    ...
    ro = Object.freeze(["item_category", "item_category2", "item_category3", "item_category4", "item_category5"]),
    Do = {},
    ...
    lo = function (a, b, c, d) {
      if (void 0 !== c)
        if ((Fo[b] && (c = Aa(c)), "anonymize_ip" !== b || c || (c = void 0), 1 === a)) d[Zn(b)] = c;
        else if (m(a)) d[a] = c;
    ...
    Go = {},
    no = Object.freeze(
      ((Go.checkout_progress = 1), (Go.select_content = 1), (Go.set_checkout_option = 1), (Go[T.g.Cb] = 1), (Go[T.g.Db] = 1), (Go[T.g.ib] = 1), (Go[T.g.jb] = 1), (Go[T.g.Eb] = 1), (Go[T.g.xa] = 1), (Go[T.g.Fb] = 1), (Go[T.g.ya] = 1), Go)
    ),
    Ho = {},
    ...
    Jo = {},
    Ko = Object.freeze(((Jo.generate_lead = 1), (Jo.login = 1), (Jo.search = 1), (Jo.select_content = 1), (Jo.share = 1), (Jo.sign_up = 1), (Jo.view_search_results = 1), (Jo[T.g.jb] = 1), (Jo[T.g.Eb] = 1), (Jo[T.g.ya] = 1), Jo)),
    Lo = function (a) {
      var b = "general";
    ...
    co = function (a, b, c) {
      ...
      for (var r = c.getTopLevelKeys(), t = 0; t < r.length; ++t) {
        ...
        if (c.isGtmEvent) {
          var v = d(u);
          Co.hasOwnProperty(u) ? (e[u] = v) : xo.hasOwnProperty(u) ? (k[u] = v) : (g[u] = v);
        } else {
          var y = void 0;
          ...
          if (Bo.hasOwnProperty(u)) lo(Bo[u], u, y, e);
          ...
          else if (/^(dimension|metric|content_group)\d+$/.test(u)) lo(1, u, y, f);
          else if (u === T.g.X) {
            if (!uo) {
              var x = Ma(y);
              x && (f["&did"] = x);
            ...
            var w = void 0,
              A = void 0;
            b === T.g.Ea ? (w = Ma(c.getMergedValues(u), ".")) : ((w = Ma(c.getMergedValues(u, 1), ".")), (A = Ma(c.getMergedValues(u, 2), ".")));
            w && (f["&gdid"] = w);
            A && (f["&edid"] = A);
      ...
      if (c.isGtmEvent) {
        ...
        "login" === b || "sign_up" === b || "share" === b ? ho(e, "eventLabel", d(T.g.Cf)) : "search" === b || "view_search_results" === b ? ho(e, "eventLabel", d(T.g.Jh)) : "select_content" === b && ho(e, "eventLabel", d(T.g.wh));
        var C = e[T.g.oa] || {},
          E = C[T.g.Jb];
    ...
    jo = function (a, b) {
      function c(t) {
        return { id: d(T.g.ab), affiliation: d(T.g.zh), revenue: d(T.g.ja), tax: d(T.g.zf), shipping: d(T.g.je), coupon: d(T.g.Ah), list: d(T.g.ie) || t };
      }
      for (
        var d = function (t) {
      ...
      if (wb(k))
        for (var l = 0; e && l < e.length; ++l) {
          var n = e[l],
            p;
          for (p in k) k.hasOwnProperty(p) && /^(dimension|metric)\d+$/.test(p) && void 0 != k[p] && ho(n, p, n[k[p]]);
        }
      var q = null,
        r = d(T.g.Bh);
      a === T.g.xa || a === T.g.Fb
        ...
        ? (q = { action: "checkout", xb: so(e), eb: { step: a === T.g.ib ? 1 : d(T.g.yf), option: d(T.g.xf) } })
        : "set_checkout_option" === a && (q = { action: "checkout_option", eb: { step: d(T.g.yf), option: d(T.g.xf) } });
      q && (q.Le = d(T.g.na));
      return q;
    },
    Po = {},
        ...
        if (f) {
          ...
          var r = zi(d.O).prefix,
            ...
            u = Rm(
              Qm(
                Sm(
                  Pm(Om(Mm(Lm(Nm(Km(Jm(Im(new Hm(d.messageContext.eventId, d.messageContext.priorityId), g), k), l), n), p), q), d.messageContext.eventMetadata), function () {
                    if (t) {
                      var v = t;
                      t = void 0;
                      v("2");
  ...
  h.flush = function (a) {
    for (var b = this, c = [], d = !1, e = {}; this.h.length; ) {
      var f = this.h[0];
      if (f.messageContext.deferrable) !f.O || bp(this, f.O).h ? ((f.messageContext.deferrable = !1), this.h.push(f)) : c.push(f), this.h.shift();
      else {
        var g = void 0;
        switch (f.type) {
          case "require":
  ...
  var ep = function (a, b) {
    if ("require" !== b.type)
      if (b.O) for (var c = a.getCommandListeners(b.O)[b.type] || [], d = 0; d < c.length; d++) c[d]();
      else
        for (var e in a.s)
  ...
  var hp = {},
    ...
    mp = function () {
      ...
      if (Array.isArray(a)) for (var b = 0; b < a.length; ++b) lp(a[b], "default");
      var c = U.pendingDestinationIds;
      delete U.pendingDestinationIds;
      if (Array.isArray(c)) for (var d = 0; d < c.length; ++d) kp(c[d][0], c[d][1]);
    },
    lp = function (a, b) {
      b = b.toString().split(",");
    ...
    for (var a = !1, b; !Aq && (b = Gq()); ) {
      ...
      if (null == d) Aq = !1;
        ...
        try {
          ...
          if ("number" === typeof y) {
            for (var x = wq[String(y)] || [], w = 0; w < x.length; w++) yq.push(Iq(x[w]));
            x.length && yq.sort(Bq);
            delete wq[String(y)];
            vq = y;
          }
  ...
  var Lq = function () {
      ...
      b.push = function () {
        ...
        if (this.length > n) for (Q(4), c.pruned = !0; this.length > n; ) this.shift();
  ...
  var Oq = function (a) {
    this.h = function (b) {
      for (var c = [], d = 0; d < a.length; d++) c.push(a[d] === Nq.qd ? b : a[d]);
      return c.join("");
    };
  };
  ...
  Oq.prototype.valueOf = Oq.prototype.toString;
  Nq.Wh = Oq;
  Nq.Ee = {};
  Nq.ii = function (a) {
    return new Oq(a);
  ...
  Nq.Ui = function (a) {
    ...
    var b = Rd();
    Nq.Ee[b] = a;
    return 'google_tag_manager["' + gg.I + '"].macro(' + b + ")";
  };
  Nq.Ni = function (a, b, c) {
    a instanceof Nq.Wh && ((a = a.h(Nq.cj(b, c))), (b = oa));
    return { zi: a, onSuccess: b };
  };
  ...
  var Vu = window,
    ...
    Xu = function (a) {
      ...
      if ((b && b.ioo && b.ioo()) || (a && !0 === Vu["ga-disable-" + a])) return !0;
      try {
        var c = Vu.external;
        if (c && c._gaUserPrefs && "oo" == c._gaUserPrefs) return !0;
      } catch (f) {}
      for (var d = Hf("AMP_TOKEN", String(Wu.cookie), !0), e = 0; e < d.length; e++) if ("$OPT_OUT" == d[e]) return !0;
  ...
  var Jv = function (a, b, c, d, e) {
    ...
    Kv = function (a, b, c, d, e) {
      if (Xi[13]) {
        ...
        e.deferrable = !0;
        km(f, c, e);
      } else (e = e || {}), (e.deferrable = !0), (e.fromContainerExecution = !0), Vo(b, d, a, e);
    },
    Mv = function (a, b, c) {};
  function Lv(a, b, c) {}
  var Z = { m: {} };
    ...
    (function () {
      (function (a) {
        ...
        if (m(b) && 0 === b.indexOf("G-")) {
          var c = ns(a.vtp_fieldsToSet, "name", "value") || {};
          if (c.hasOwnProperty(T.g.Ia) || a.vtp_userProperties) {
            var d = c[T.g.Ia] || {};
            M(ns(a.vtp_userProperties, "name", "value"), d);
            c[T.g.Ia] = d;
          }
          a.vtp_enableSendToServerContainer && a.vtp_serverContainerUrl && ((c[T.g.V] = a.vtp_serverContainerUrl), (c[T.g.hc] = !0));
          ...
          var f = c[T.g.V] || tr(T.g.V, 2);
          dm(b, f, !0);
          km(gm(b, c), a.vtp_gtmEventId, { noTargetGroup: !0, originatingEntity: ul(a.vtp_gtmEntityIndex, a.vtp_gtmEntityName) });
  ...
  (Z.m.f = ["google"]),
    (function () {
      (function (a) {
        ...
        var b = tr("gtm.referrer", 1) || H.referrer;
        return b ? (a.vtp_component && "URL" != a.vtp_component ? re(te(String(b)), a.vtp_component, a.vtp_stripWww, a.vtp_defaultPages, a.vtp_queryKey) : sr(String(b))) : String(b);
      });
    })();
  ...
  (Z.m.u = ["google"]),
    (function () {
      ...
      (function (b) {
        ...
        var c;
        c = (c = b.vtp_customUrlSource ? b.vtp_customUrlSource : tr("gtm.url", 1)) || qr();
  ...
  (Z.m.ua = ["google"]),
    (function () {
      function a(l, n) {
        for (var p in l)
          if (!k[p] && l.hasOwnProperty(p)) {
            var q = g[p] ? Aa(l[p]) : l[p];
      ...
      function b(l) {
        var n = {};
        l.vtp_gaSettings && M(ns(l.vtp_gaSettings.vtp_fieldsToSet, "fieldName", "value"), n);
        M(ns(l.vtp_fieldsToSet, "fieldName", "value"), n);
      ...
      function e(l, n) {
        if (!f) {
          ...
          var q = l.vtp_gtmOnFailure,
            r = $l(n._x_19, "/analytics.js"),
            t = Di("https:", "http:", "//www.google-analytics.com/" + p, n && !!n.forceSSL);
          W(
      ...
      (function (l) {
        ...
        if (l.vtp_gaSettings) {
          ...
          M(ns(t.vtp_contentGroup, "index", "group"), p);
          M(ns(t.vtp_dimension, "index", "dimension"), q);
          M(ns(t.vtp_metric, "index", "metric"), r);
          var u = M(t);
        ...
        M(ns(l.vtp_contentGroup, "index", "group"), p);
        M(ns(l.vtp_dimension, "index", "dimension"), q);
        M(ns(l.vtp_metric, "index", "metric"), r);
        var v = b(l),
          y = String(l.vtp_trackingId || ""),
          x = "",
          w = "",
          A = "";
        l.vtp_setTrackerName && "string" == typeof l.vtp_trackerName ? "" !== l.vtp_trackerName && ((A = l.vtp_trackerName), (w = A + ".")) : ((A = "gtm" + Rd()), (w = A + "."));
        var z = function (V, P) {
          for (var ia in P) P.hasOwnProperty(ia) && (v[V + ia] = P[ia]);
        };
        z("contentGroup", p);
        z("dimension", q);
        z("metric", r);
        ...
        if ("TRACK_EVENT" === l.vtp_trackType)
          (x = "track_event"), n(), (v.eventCategory = String(l.vtp_eventCategory)), (v.eventAction = String(l.vtp_eventAction)), (v.eventLabel = c(String, l.vtp_eventLabel)), (v.value = c(ya, l.vtp_eventValue));
        else if ("TRACK_PAGEVIEW" == l.vtp_trackType) {
          if (((x = T.g.Yb), n(), "DISPLAY_FEATURES_WITH_REMARKETING_LISTS" == l.vtp_advertisingFeaturesType && (v.remarketingLists = !0), l.vtp_autoLinkDomains)) {
            var C = {};
            C[T.g.N] = l.vtp_autoLinkDomains;
            C.use_anchor = l.vtp_useHashAutoLink;
            C[T.g.Kb] = l.vtp_decorateFormsAutoLink;
            v[T.g.oa] = C;
          }
        } else
          "TRACK_SOCIAL" === l.vtp_trackType
            ? ((x = "track_social"), (v.socialNetwork = String(l.vtp_socialNetwork)), (v.socialAction = String(l.vtp_socialAction)), (v.socialTarget = String(l.vtp_socialActionTarget)))
            : "TRACK_TIMING" == l.vtp_trackType &&
              ((x = "timing_complete"), (v.eventCategory = String(l.vtp_timingCategory)), (v.timingVar = String(l.vtp_timingVar)), (v.value = ya(l.vtp_timingValue)), (v.eventLabel = c(String, l.vtp_timingLabel)));
        ...
        var G = Sm(Pm(Im(new Hm(l.vtp_gtmEventId, l.vtp_gtmPriorityId), E), l.vtp_gtmOnSuccess), l.vtp_gtmOnFailure);
        G.isGtmEvent = !0;
        qo(y, x, Date.now(), G);
        var D = Kl(l.vtp_functionName);
        if (pa(D)) {
          var L = function (V) {
      ...
      function b(d) {
        if (H.body) {
          var e = d.vtp_gtmOnFailure,
            f = Cr(d.vtp_html, d.vtp_gtmOnSuccess, e),
            g = f.zi,
            k = f.onSuccess;
          if (d.vtp_useIframe) {
          } else d.vtp_supportDocumentWrite ? c(g, k, e) : a(H.body, pb(g), k, e)();
        } else
          or(function () {
            b(d);
          }, 200);
  ...
  var Nv = {};
  (Nv.macro = function (a) {
    if (Nq.Ee.hasOwnProperty(a)) return Nq.Ee[a];
  }),
    (Nv.onHtmlSuccess = Nq.qg(!0)),
    (Nv.onHtmlFailure = Nq.qg(!1));
  Nv.dataLayer = Yd;
  ...
  (function (a) {
    ...
    var f = function (q) {
        ...
        var v = { messageType: "CONTAINER_STARTING", data: { scriptSource: bb, containerProduct: r, debug: !1, id: gg.I, isGte: Md } };
    ...
    if (b) {
      ...
      for (var k = data.resource || {}, l = k.macros || [], n = 0; n < l.length; n++) Yb.push(l[n]);
      ...
      for (var u = k.rules || [], v = 0; v < u.length; v++) {
        for (var y = u[v], x = {}, w = 0; w < y.length; w++) x[y[w][0]] = Array.prototype.slice.call(y[w], 1);
        Zb.push(x);
      }
      cc = Z;
      dc = ds;
      ...
      for (var A = lg(), z = ig(), C = 0; C < z.length; C++) A.container[z[C]] = !0;
      ...
      ol = !1;
      pl = 0;
      if (("interactive" == H.readyState && !H.createEventObject) || "complete" == H.readyState) rl();
      else {
