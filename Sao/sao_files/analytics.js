  ...
  var A = /:[0-9]+$/,
    ...
    E = function (a, b) {
      ...
      "port" === b
        ...
        : "host" === b && (a.hostname = (a.hostname || t.location.hostname).replace(A, "").toLowerCase());
    ...
    pd = function (a) {
      ...
      if (d && a.get(cc) && (b = M.location.hash)) {
        ...
        for (k = 0; k < b.length; ++k)
          (D(b[k], "utm_id") || D(b[k], "utm_campaign") || D(b[k], "utm_source") || D(b[k], "utm_medium") || D(b[k], "utm_term") || D(b[k], "utm_content") || D(b[k], "gclid") || D(b[k], "dclid") || D(b[k], "gclsrc") || D(b[k], "wbraid")) &&
            d.push(b[k]);
